...
function BookAppointment() {
  ...
  const [form, setForm] = useState({ doctorId: '', appointmentDate: '', reason: '', painLevel: '1' });
    ...
    try {
      ...
      const response = await axiosInstance.put(`/patient/${patient._id}`, {
        doctorAppointment: {
          ...
          painLevel: parseInt(form.painLevel || '1', 10),
