...
useEffect(() => {
  ...
  // Find lab record - handle if labRecords is undefined or has different structure
  if (labRecords) {
    // Check different possible structures
    let foundLabRecord = null;
    ...
    if (Array.isArray(labRecords)) {
      ...
      foundLabRecord = labRecords.data.find(
        item => item.patientUniqueId === userID
      );
    }
  ...
  if (xrayRecords && Array.isArray(xrayRecords)) {
    ...
    // If xrayRecords has records property
    const foundXrayRecord = xrayRecords.records.find(
      item => item.patientUniqueId === userID
    );
    setXrayRecord(foundXrayRecord || null);
  }
                  ...
                  <div className="border border-gray-200 rounded-lg p-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                      ...
                      <div>
                        ...
                        <p className="font-medium">{labRecord.instructions}</p>
                      </div>
                      <div className="md:col-span-2">
                ...
                {!xrayRecord ? (
                  ...
                  <div className="border border-gray-200 rounded-lg p-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                      ...
                      <div>
                        <label className="text-sm text-gray-600">Instructions</label>
                        <p className="font-medium">{xrayRecord.instructions}</p>
                      </div>
                      <div className="md:col-span-2">
                        <label className="text-sm text-gray-600">Charges Details</label>
...
export default PatientDetailsByDoctor;